...
namespace ROWM.Dal
{
    public partial class ParcelRelocation : IParcelRelocation
    {
        ...
        public IRelocationCase AddCase(string displaceeName, RelocationStatus eligibility, DisplaceeType displaceeType, RelocationType reloType, FinancialAssistType finAssisType, double finAssisAmount)
        {
            ...
            var aCase = new RelocationCase
            {
                ...
                FinancialAssistType = finAssisType,
                FinancialAssistAmount = finAssisAmount
            };
